<x-app-layout>
    {{-- HERO --}}
    <section class="min-h-[500px] h-[500px] lg:h-[630px] bg-compra bg-no-repeat bg-center bg-cover">
        ...
        <div class="max-w-screen-lg px-4 mx-auto my-auto sm:px-6 lg:px-8">
            <article id="trabaja" class="grid grid-cols-5 gap-4">
                ...
                <div class="hidden lg:block lg:col-span-1">
                    <img src="{{ asset('images/ads/renax-ads.jpg') }}" alt="" class="w-full">
                </div>
            </article>
            ...
            <div class="py-8">
                <img src="{{ asset('images/ads/argenprop-ads.jpg') }}" alt="" class="w-full">
            </div>
