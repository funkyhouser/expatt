<x-app-layout>
    ...
    <section class="py-12 bg-white">
        <div id="conoce-argentina" class="max-w-screen-xl px-4 mx-auto my-auto sm:px-6 lg:px-8">
            ...
            <div class="grid gap-3 font-black text-white gap-y-6 lg:grid-cols-3">
                ...
                <a href="{{ url('/mudanzas/argentina') }}" class="flex flex-col overflow-hidden bg-white rounded drop-shadow-md">
                    <div class="h-64">
                ...
                <a href="{{ url('/alojamiento/argentina') }}" class="flex flex-col overflow-hidden bg-white rounded drop-shadow-md">
                    <div class="h-64">
     ...
     <section class="py-12 bg-white">
        <div class="max-w-screen-lg px-4 mx-auto my-auto sm:px-6 lg:px-8">
            ...
            <div class="grid justify-center gap-4 text-lg font-black text-white lg:grid-cols-3 lg:text-2xl">
                ...
                <a href="{{ url('/asesoria-juridica/argentina') }}" class="overflow-hidden rounded hover:shadow-md">
                ...
                <a href="{{ url('/telefonia-internet/argentina') }}" class="overflow-hidden rounded hover:shadow-md">
    ...
    <section class="bg-[#25E59B]">
        <div class="grid font-black text-lg text-white lg:grid-cols-[1.5fr_1fr_1fr] lg:h-[570px]">
            ...
            <a href="{{ url('/transferencia-de-dinero/argentina') }}"
                class="relative flex flex-col items-center justify-end isolate min-h-[300px]">
        ...
        <div id="conoce-argentina" class="max-w-screen-lg px-4 mx-auto my-auto sm:px-6 lg:px-8">
            ...
            <div class="grid gap-3 font-black text-white gap-y-6 lg:grid-cols-2">
                <a href="{{ url('/gastronomia-delivery/mexico') }}" class="flex flex-col overflow-hidden bg-white rounded drop-shadow-md">
                    ...
                    <p class="text-center py-3 text-2xl font-black text-white bg-[#47108E]">Gastronomia/Delivery</p>
                </a>
                <a href="{{ url('/servicio-domestico/argentina') }}" class="flex flex-col overflow-hidden bg-white rounded drop-shadow-md">
                    <div class="h-64">
                ...
                {{-- --}}
                <a href="{{ url('/apoyo-psicologico/argentina') }}" class="flex flex-col overflow-hidden bg-white rounded drop-shadow-md">
                    <div class="h-64">
                ...
                <a href="{{ url('/idiomas-intercambio/argentina') }}" class="flex flex-col overflow-hidden bg-white rounded drop-shadow-md">
                    <div class="h-64">
